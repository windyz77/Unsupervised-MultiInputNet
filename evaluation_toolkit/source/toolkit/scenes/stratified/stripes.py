...
from evaluation_toolkit.source.toolkit.utils import plotting
...
class Stripes(BaseStratified):
    ...
    def get_scene_specific_metrics():
        from evaluation_toolkit.source.toolkit.metrics import StripesLowTexture, DarkStripes, BrightStripes
