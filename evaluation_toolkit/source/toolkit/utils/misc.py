...
import sys
# sys.path.append("/home/zhouenci/PycharmProjects/untitled/main/evaluation_toolkit/source")
# print (sys.path)
# from toolkit import settings
# from toolkit import settings
# from toolkit import settings
from evaluation_toolkit.source.toolkit import settings
# import settings_from_toolkit
# import settings
# from evaluation_toolkit.source.toolkit import settings
# from toolkit.utils import file_io, log
from evaluation_toolkit.source.toolkit.utils import file_io, log
...
def get_photorealistic_scene(scene_name, category, gt_scale=1.0, data_path=None):
    ...
    from evaluation_toolkit.source.toolkit.scenes import PhotorealisticScene
...
def get_stratified_scene(scene_name, gt_scale=1.0, data_path=None):
    ...
    from evaluation_toolkit.source.toolkit.scenes import Backgammon, Pyramids, Dots, Stripes
...
def get_all_metrics():
    from evaluation_toolkit.source.toolkit.metrics import Runtime
...
def get_general_metrics():
    from evaluation_toolkit.source.toolkit.metrics import MSE, BadPix, Quantile
    return [MSE(), BadPix(0.01), BadPix(0.03), BadPix(0.07), Quantile(25)]


def get_region_metrics():
    from evaluation_toolkit.source.toolkit.metrics import Discontinuities, FineFattening, FineThinning, \
